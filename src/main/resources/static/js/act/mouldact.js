        ...
        $.ajax({
            ...
            "success": function(data){
                ...
                if(json.status==="SUCCESS"){
                    ...
                    //$("select[name='mouldCode']").val(actManager.mouldCode).trigger("change");
                        ...
                        for(let conf in module){
                            if(conf === "picCnf"){
                                ...
                                for(let value in moduleConf){
                                    $("#"+value+"Values"+suffix).attr(value+"ID",moduleConf[value].id);
                                    $("#"+value+"Img"+suffix).attr("src",moduleConf[value].url);
                                }
                            }
                            if(conf === "textCnf"){
                                let moduleConf = module[conf];
                                for(let value in moduleConf){
                                    $("#"+value+suffix).val(moduleConf[value]);
                                }
                            }
                        }
                    }
...
/*function addTr() {
    ...
    //clone.find(".number").attr("name","actResDetails["+number+"].number");
