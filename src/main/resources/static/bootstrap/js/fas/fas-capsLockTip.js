    ...
    $.CapsLockTip = function (___target) {
        ...
        $(document).ready(function () {
            ...
            if(null == $.fn.capsLockTip.divTip){
                $("body").append("<div id='divTip__985124855558842555' style='width:100px; height:20px; margin-top:-60px; display:none; position:absolute; z-index:9999999999999; text-align:center; background-color:#ff892a; color:white; font-size:12px; border:solid 1px #DBC492; border-bottom-color:#B49366; border-right-color:#B49366;'>大写锁定已打开</div>");
